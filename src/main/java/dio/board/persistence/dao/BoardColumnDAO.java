...
import static dio.board.persistence.entity.BoardColumnKindEnum.findByName;
        ...
        try(var statement = connection.prepareStatement(sql)){
            ...
            if (resultSet.next()){
                ...
                do {
                    ...
                    OffsetDateTime offsetDateTime = OffsetDateTime.ofInstant(resultSet.getTimestamp("c.created_at").toInstant(), ZoneOffset.UTC);
                    card.setCreatedAt(offsetDateTime);
